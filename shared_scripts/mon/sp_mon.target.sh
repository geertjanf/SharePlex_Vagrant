...
export SP_HOME=/u01/app/quest/
export SP_SYS_VARDIR=/u01/app/quest/vardir/2100 
export SP_SYS_BINDIR=$SP_HOME/bin
export SP_MONDIR=/vagrant_scripts/mon/log
export SP_SCRIPTS=/vagrant_scripts/mon
export SP_SYS_UTILDIR=$SP_HOME/util
export SP_SYS_HOST_NAME=ol7-19-splex2.localdomain
export SRC_ORACLE_SID=pdb1
export SPLEX_UNAME=$SP_COP_TPORT
export PLS_MAIL=FALSE
export NO_MAIL=TRUE
export INTERVAL=600
############################################################
...
#### post speed monitor
############################################################
$SP_SCRIPTS/sp_speedofpost.sh -b $SP_SYS_BINDIR -v $SP_SYS_VARDIR -m $SP_MONDIR -p $SP_COP_TPORT -t $INTERVAL -e $PLS_MAIL
